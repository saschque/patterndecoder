...
from transformer_models.transformer import DecoderLayer as TransformerDecoderLayer
...
class AutoformerBlock(TransformerBlock):
    ...
    Inherits all parameters from TransformerBlock:
        ...
        training_params (dict): Training configuration including dropout,
            l1_reg, and l2_reg.
        attn (dict): Attention mechanisms with enc_attn (AutoCorrelation recommended)
